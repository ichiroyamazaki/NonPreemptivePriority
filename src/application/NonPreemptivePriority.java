...
public class NonPreemptivePriority extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            for (Process process : processes) {
                ...
                System.out.printf("| %-5d | %-10d | %-8d | %-6d | %-9d | %-13d | %-10d |%n",
                        process.getPid(), process.getArrivalTime(), process.getBurstTime(),
                        process.getPriority(), process.getCompleteTime(), process.getTurnaroundTime(), process.getWaitingTime());
            ...
            System.out.println("|-------|------------|----------|--------|-----------|---------------|------------|");
            System.out.printf("%nTotal Time: %d%n", totalTime);
            System.out.printf("Average Waiting Time: %.2fms%n", (double) totalWaitingTime / numProcesses);
            System.out.printf("Average Turnaround Time: %.2fms%n", (double) totalTurnaroundTime / numProcesses);

            displayGanttChart(ganttTasks, totalTime);
            System.out.println("");
            System.out.print("The processes have been completed. Do you want to restart? (Y/N): ");
            String restartChoice = scanner.next().toLowerCase();
            if (restartChoice.equals("y")) {
                start(primaryStage);
            } else {
                System.out.println("Program terminated. Showing the Gantt Chart...");
                System.out.println("");
                System.out.println("This code was made by John Patrick Dulap | From: BSCpE-2A");
                System.out.println("For Operating Systems (Finals)");
                primaryStage.close();
            }
        }
    }
    ...
    private void displayGanttChart(ArrayList<GanttTask> ganttTasks, int totalTime) {
        ...
        ganttStage.setTitle("Gantt Chart | Non Preemptive Priority");
